...
/* This is probably one of the craziest **** that I've attempted in my SL history. It took me one sleepless night to calculate and discover the algorithm behind converting a mxm array to a (not so) proper *coughs* cartesian plane, AND I HAD TO FIX DISPLAY ISSUE BECAUSE SL MOBILE CODE PLAYGROUND DOESN'T DISPLAY ASCII CHARACTER WIDTH PROPERLY AND MESSED UP THE GRAPH. I originally wanted to make the values float, but now just want to go and sleep for the rest of the day. 
